    ...
    fs.readFile(file, (err, data) => {
        ...
        asyncForEach(items, async (element) => {
            ...
            if (element.hasOwnProperty('item')) {
                ...
                // main pages path
                const mainpagesPath = '../main.pages.js';
                // write pages dir
                ...
                asyncForEach(element.item, async (second) => {
                    if (second.hasOwnProperty('item') == false) {
                        ...
                        writePages(second, pagesPath, jsonSchemaRelativePath, helperPath, mainpagesPath, moduleType)
                        ...
                        asyncForEach(second.item, async (third) => {
                            ...
                            if (third.hasOwnProperty('item') == false) {
                                ...
                                writePages(third, third_page, third_schRe, third_helpRe, third_mainRe, moduleType)
                                ...
                                asyncForEach(third.item, async (fourth) => {
                                    ...
                                    if (fourth.hasOwnProperty('item') == false) {
                                        ...
                                        writePages(fourth, fourth_page, fourth_schRe, fourth_helpRe, fourth_mainRe, moduleType)
                                        ...
                                        asyncForEach(fourth.item, async (fifth) => {
                                            ...
                                            if (fifth.hasOwnProperty('item') == false) {
                                                ...
                                                writePages(fifth, fifth_page, fifth_schRe, fifth_helpRe, fifth_mainRe, moduleType)
                                                ...
                                                asyncForEach(fifth.item, async (sixth) => {
                                                    ...
                                                    if (sixth.hasOwnProperty('item') == false) {
                                                        ...
                                                        writePages(sixth, sixth_page, sixth_schRe, sixth_helpRe, sixth_mainRe, moduleType)
                ...
                writePages(element, pagesPath, jsonSchemaRelativePath, helperPath, mainpagesPath, moduleType)
