...
const { schema } = require("@schema/Auth/POST_logout.schema.js");
...
class Request {
  constructor() {
    ...
    this.url = "/users/logout"; // Set up the API path to the route endpoint
  }
  ...
  async api(...args) {
    ...
    try {
      const response = await this.request
        ...
        .set(
          "Authorization",
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NGMwZGNhYWM4OGU3NzAwMTM0MjBkN2MiLCJpYXQiOjE2OTAzNjEwMjl9.9-2QzLIfOUoF_oTYHLZwoLMFxyk_2PvarfavApza4Us"
        );
